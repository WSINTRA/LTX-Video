...
def stitch_videos(video_paths: List[str], output_dir: str, output_filename: str = DEFAULT_STITCHED_FILENAME) -> str:
    """
    ...
    try:
        ...
        if os.path.exists(concat_file_path):
            try:
                ...
                logger.warning(f"Failed to remove temporary file {concat_file_path}: {e}")
...
def main():
    ...
    try:
        ...
        if result:
            ...
            print("Video generation completed. Individual videos are in the output directory.")
